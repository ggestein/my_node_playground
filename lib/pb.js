...
export default class PB {
    ...
    build() {
        ...
        l(`MAIN SITUATION COUNT BEFORE PREFILTER: ${mne.count()}`)
        let sl = []
        ...
        l(`MAIN SITUATION COUNT AFTER PREFILTER: ${sl.length}`)
        sground.__main__ = sl
        l("MAIN BUILDING COMPLETE")
        let sgraph = new Map()
